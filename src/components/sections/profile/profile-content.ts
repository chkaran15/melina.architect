...
export const profileFacts = [
  { label: "Practice", value: "Architect-led spatial design" },
  {
    label: "Focus",
    value: "Homes, interiors, renovation, calm commercial rooms",
  },
  {
    label: "Method",
    value: "Measured planning, light studies, material restraint",
  },
  { label: "Availability", value: "Selected new commissions" },
];
